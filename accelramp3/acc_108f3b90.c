// CLevelEntrustUI::BuildEntrustListVO @ 108f3b90
...
void CLevelEntrustUI__BuildEntrustListVO
                              ...
                              if ((undefined1 ******)pppppiStack_30c != (undefined1 ******)0x0) {
                                ...
                                if (cVar3 != '\0') {
                                  ...
                                  if ((int ****)pppppuStack_29c[0xac3] != (int ****)0x0) {
                                    ...
                                    uVar18 = CMHLevelInfo__CheckWildHuntPhaseRewardWindow();
...
LAB_108f5bc4:
          ...
          iVar5 = CLevelEnGroupRewardInfo__GetRewardByIndex();
          if (iVar5 != 0) {
          ...
          if ((char)((uint)unaff_EDI >> 0x18) != '\0') {
            ...
            if (((int)pppiStack_28c - (int)piStack_290) / 0x18 + iVar5 != iVar5) {
              ...
              do {
                ...
                pppiStack_28c = (int ***)CLeagueInfo__ReleaseManager();
                iVar6 = 0;
                if (0 < (int)pppiStack_28c) {
                  do {
                    pppppiStack_304 = (int *****)0x108f5f1b;
                    pppppiStack_300 = (int *****)iVar6;
                    iVar16 = CLeagueInfo__GetEntryByIndex();
                    if ((iVar16 != 0) &&
                ...
                pppiStack_28c = (int ***)CLeagueRoundSchedule__ReleaseManager();
                iVar6 = 0;
                local_2a8 = 0;
                if (0 < (int)pppiStack_28c) {
                  do {
                    ...
                    pppppiStack_300 = (int *****)iVar6;
                    iVar16 = CLeagueRoundSchedule__GetEntryByIndex();
                    if ((iVar16 != 0) &&
