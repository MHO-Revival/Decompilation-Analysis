...
void __thiscall FUN_10dcf450(float *param_1,float *param_2)

{
  ...
  if (*(char *)((int)param_1[2] + 0x1de) != '\0') {
    ...
    ppuStack_1a8 = (undefined1 **)0x10dcf4ce;
    FUN_10da16e0();
    return;
  }
  pfStack_1a4 = &local_180;
  ppuStack_1a8 = (undefined1 **)0x10dcf4eb;
  ...
  if (((0.0 < (float)(double)((ulonglong)(double)param_2[0x636] & DAT_11de9c70)) ||
      (0.0 < (float)(double)((ulonglong)(double)param_2[0x637] & DAT_11de9c70))) ||
     (0.0 < (float)(double)((ulonglong)(double)param_2[0x638] & DAT_11de9c70))) {
    ppuStack_1a8 = &puStack_164;
    pfStack_1ac = (float *)0x10dd014c;
    puVar6 = (undefined8 *)(**(code **)(*(int *)param_2[3] + 200))();
  ...
  if ((cVar3 != '\0') && (param_1[4] <= DAT_11cbf0d0 && DAT_11cbf0d0 != param_1[4])) {
    ...
    if (iVar7 != 0) goto LAB_10dcf8e2;
  }
  cVar3 = (**(code **)((int)*param_2 + 0x1d0))();
  if (cVar3 != '\0') {
    if ((DAT_11ceb51c <= fStack_10c) || (param_1[4] <= DAT_11de98bc)) {
      if ((DAT_11cbf084 <= fStack_190) || (DAT_11cbf0d0 <= param_1[4])) goto LAB_10dcfc3c;
...
LAB_10dcf8e2:
    ...
    fStack_144 = param_2[0x63b];
    fStack_12c = param_2[0x62d] + param_2[0x63a] * DAT_11df8438;
    pfStack_130 = (float *)(param_2[0x639] * DAT_11df8438 + param_2[0x62c]);
    uStack_150._4_4_ = (float)*(undefined8 *)(param_2 + 0x639);
    pfStack_148 = (float *)((ulonglong)*(undefined8 *)(param_2 + 0x639) >> 0x20);
    fStack_168 = param_2[0x62d] - (float)pfStack_148;
    fStack_128 = param_2[0x62e] + param_2[0x63b] * DAT_11df8438 + DAT_11cc9b60;
    puStack_164 = (undefined1 *)((param_2[0x62e] - fStack_144) + DAT_11cc9b60);
    uStack_170 = CONCAT44(param_2[0x62c] - uStack_150._4_4_,(float)uStack_170);
    fVar22 = param_2[0x62c] - uStack_150._4_4_;
...
LAB_10dcfc3c:
  if ((*(int *)((int)param_1[2] + 0x22c) != 5) && (*(int *)((int)param_1[2] + 0x22c) != 4)) {
    ...
    fVar11 = (float10)(**(code **)(*(int *)param_1[0x89] + 0x764))();
