// FUN_10bb59b0 @ 10bb59b0
// ramp offsets referenced: [536, 540, 544, 548, 552]


/* [RE-AUTO c0] */

void __fastcall FUN_10bb59b0(int param_1)

{
  ...
  if (iVar2 != 0) {
    *(int *)(iVar2 + -0xc) = *(int *)(iVar2 + -0xc) + -1;
    if (*(int *)(iVar2 + -0xc) < 1) {
      (**(code **)(**(int **)(DAT_1202e818 + 0x70) + 0xc))((int *)(iVar2 + -0xc));
    }
  }
  ...
  if (*(int *)(param_1 + 0x94) != 0) {
    uVar1 = FUN_1083ab00(*(int *)(param_1 + 0x94));
    iVar2 = FUN_1083aae0();
    if (iVar2 < 1) {
      piVar3 = (int *)FUN_1083aaf0();
      (**(code **)(*piVar3 + 0xc))(uVar1);
    }
  }
  FUN_1083ab40();
  FUN_1083ab40();
