// === RTTI-resolved: CNodeRepeatExecuteCounter ===
// nameStr@1130d778 td@1130d770 vftables=[]

// ---- VIRTUAL METHODS (per-tick logic) ----

// ---- CREATE / FACTORY SITES ----
// creator FUN_105f9750 @ 105f9750

/* [RE-AUTO c0]
   strings:
     ""MaxRepeatTimes""
     ""CNodeRepeatExecuteCounter"" */

void FUN_105f9750(void)

{
  ...
  local_24 = local_34;
  local_20 = local_24;
  FUN_1001ea30("MaxRepeatTimes","");
  local_c = local_1c;
  local_8 = local_c;
  FUN_1001ea30("CNodeRepeatExecuteCounter","");
