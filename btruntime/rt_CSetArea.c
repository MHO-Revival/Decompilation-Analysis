// === RTTI-resolved: CSetArea ===
// nameStr@1130b814 td@1130b80c vftables=[]
...

{
  ...
  local_24 = local_34;
  local_20 = local_24;
  FUN_1001ea30("ToSetAreaBBName","");
  local_c = local_1c;
  local_8 = local_c;
  FUN_1001ea30("CSetArea","");
