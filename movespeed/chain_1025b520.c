// FUN_1025b520 @ 1025b520  depth 2  (265 bytes)


/* [RE-AUTO c0] */

void __thiscall FUN_1025b520(int param_1,undefined4 param_2,undefined1 param_3)
...
LAB_1025b614:
  ...
  puStack_40 = (undefined4 *)0x1025b555;
  piVar1 = (int *)(**(code **)(**(int **)(param_1 + 0x1c) + 8))();
  if (piVar1 == (int *)0x0) goto LAB_1025b614;
  puStack_3c = (undefined1 *)0x1025b564;
  iVar2 = (**(code **)(*piVar1 + 4))();
  if (iVar2 == 0) goto LAB_1025b614;
  ...
  if ((*(char *)(param_1 + 0x60) != '\0') && (*(int **)(param_1 + 0x1c) != (int *)0x0)) {
    puStack_3c = *(undefined1 **)(param_1 + 0x5c);
    puStack_40 = (undefined4 *)0x1025b5a1;
    piVar1 = (int *)(**(code **)(**(int **)(param_1 + 0x1c) + 8))();
    if (piVar1 != (int *)0x0) {
      puStack_3c = (undefined1 *)0x1025b5ac;
