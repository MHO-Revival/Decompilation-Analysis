...
LAB_10f19cd1:
    ...
    if (bVar1 != pbVar9[1]) goto LAB_10f19cd1;
    pbVar7 = pbVar7 + 2;
    pbVar9 = pbVar9 + 2;
  } while (bVar1 != 0);
  uVar8 = 0;
...
LAB_10f19d00:
      ...
      if (bVar1 != pbVar4[1]) goto LAB_10f19d00;
      pbVar3 = pbVar3 + 2;
      pbVar4 = pbVar4 + 2;
    } while (bVar1 != 0);
    uVar8 = 0;
LAB_10f19d05:
    if (uVar8 != 0) goto LAB_10f19d0d;
  }
  if (iVar2 != 0) {
    if (*(int *)(param_1 + 0x2374) == 0) {
      piVar5 = (int *)(**(code **)(*DAT_120286c8 + 0x3c))();
      uVar6 = (**(code **)(*piVar5 + 0x1d4))();
      *(undefined4 *)(param_1 + 0x2374) = uVar6;
    }
    (**(code **)(**(int **)(param_1 + 0x2374) + 0x1c))
...
LAB_10f19d0d:
  if (*(int **)(param_1 + 0x2374) == (int *)0x0) {
    return;
  }
                    /* WARNING: Could not recover jumptable at 0x10f19d20. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(**(int **)(param_1 + 0x2374) + 0x10))();
  return;
}
