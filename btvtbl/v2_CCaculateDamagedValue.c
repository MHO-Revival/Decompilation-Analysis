...
// ===== CCaculateDamagedValue vtbl[4] @105609e0 =====

undefined4 FUN_105609e0(void)
...
// ===== CCaculateDamagedValue vtbl[7] @10560ab0 =====

char * FUN_10560ab0(void)

{
  return "CCaculateDamagedValue";
}

// vtbl[8] @103dc6d0  (emitted elsewhere)
// vtbl[9] @103dc830  (emitted elsewhere)

// ===== CCaculateDamagedValue vtbl[10] @10560ac0 =====

/* [RE-AUTO c0] */

void __thiscall FUN_10560ac0(undefined4 param_1,int *param_2)

{
  ...
  if (cVar1 == '\0') {
    (**(code **)(*param_2 + 0x4c))(param_1,0x70,1);
...
// ===== CCaculateDamagedValue vtbl[13] @105609f0 =====
...
void __fastcall FUN_105609f0(int param_1)

{
  undefined4 uVar1;
  
  uVar1 = FUN_10a5d620("Health");
