...

{
  ...
  local_24 = local_34;
  local_20 = local_24;
  FUN_1001ea30("MaxDistance","");
  local_c = local_1c;
  local_8 = local_c;
  FUN_1001ea30("CIsNearSwitchRegionPoint","");
  FUN_103cf720(local_1c,local_34,1,2,0);
  FUN_103cf810();
  ...
  local_20 = local_24;
  FUN_1001ea30("CIsNearSwitchRegionPoint","");
  FUN_103cf720(local_34,local_1c,0);
  FUN_103cf8f0();
  if ((local_20 != local_34) && (local_20 != (undefined1 *)0x0)) {
    FUN_10653dc0(local_20);
  }
